...
def main():
    parser=argparse.ArgumentParser(description="Run LMO-MOO ablation experiments.")
    parser.add_argument("--problem",choices=("effect_k","lmo_geometry","local_smoothness","hyperparameter_transfer"),required=True)
